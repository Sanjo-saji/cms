...
const ChatScreen = () => {
  ...
  useEffect(() => {
    const fetchMessages = async () => {
      try {
        // --- CORRECTED PATH ---
        const response = await API.get(`/chat/student/chat/${id}`);
  ...
  const handleRegenerateAnonId = async () => {
    Alert.alert(
      "Reset Anonymous ID",
      "This will reset your anonymous ID and update all existing chats. Old messages will become untraceable for privacy. Continue?",
      [
          ...
          onPress: async () => {
            try {
              ...
              if (response.status === 200) {
                Alert.alert(
                  "Success",
                  "Your anonymous ID has been reset and all chats updated."
                );
              } else {
              ...
              Alert.alert(
                "Error",
                "Failed to reset anonymous ID. Please try again."
              );
            }
          },
        },
      ...
      <View style={styles.header}>
        <View style={styles.headerContent}>
          ...
          <View style={styles.headerTextContainer}>
            <Text style={styles.headerTitle}>{name || "Teacher"}</Text>
